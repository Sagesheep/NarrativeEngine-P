...
const CAMPAIGN_FILE_SUFFIXES = [
    '.json', '.state.json', '.lore.json', '.npcs.json', '.enemies.json', '.abilities.json', '.known-abilities.json', '.enemy-instances.json', '.enemy-encounters.json', '.enemy-resolutions.json', '.enemy-combat.json', '.locations.json',
