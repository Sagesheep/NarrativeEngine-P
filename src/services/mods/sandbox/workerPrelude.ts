...
export function buildWorkerSource(modSource: string): string {
    ...
    return [
        ...
        '  throw new Error("[sandbox] " + name + " is native-tier only (EVENTS.md §5.1 / MOUNTS.md §8.1); a sandboxed compute mod cannot hold a listener or a mount closure across a run");',
        '};',
