...
export function buildWorkerSource(modSource: string): string {
    ...
    return [
        ...
        '  throw new Error("[sandbox] " + name + " is native-tier only (EVENTS.md §5.1 / MOUNTS.md §8.1 / Phase 5.1 §2 / Phase 5.4 / Phase 7.4); a sandboxed compute mod cannot hold a listener, a mount closure, a macro resolver, a fact publisher, a budget allocator, or a tokenizer across a run");',
        '};',
        ...
        '    header: __sandboxNativeOnly("ctx.mounts.header"),',
        '    composer: __sandboxNativeOnly("ctx.mounts.composer"),',
        '    messageAction: __sandboxNativeOnly("ctx.mounts.messageAction"),',
        '    rail: __sandboxNativeOnly("ctx.mounts.rail"),',
        '    messageBelow: __sandboxNativeOnly("ctx.mounts.messageBelow"),',
        '    window: __sandboxNativeOnly("ctx.mounts.window"),',
        '  }),',
        '  macros: Object.freeze({',
        '    register: __sandboxNativeOnly("ctx.macros.register"),',
        '  }),',
        '  facts: Object.freeze({',
        '    register: __sandboxNativeOnly("ctx.facts.register"),',
        '  }),',
        '  budgets: Object.freeze({',
        '    claim: __sandboxNativeOnly("ctx.budgets.claim"),',
        '  }),',
        '  tokens: Object.freeze({',
        '    count: __sandboxNativeOnly("ctx.tokens.count"),',
        '  }),',
        '  roles: __sandboxNativeOnly("ctx.roles"),',
        '};',
