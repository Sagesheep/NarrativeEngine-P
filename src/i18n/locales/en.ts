...
export const en = {
    ...
    'header.abilityCompendium.tooltip': 'Ability & Power Compendium',
    'header.abilityCompendium.aria': 'Open Ability & Power Compendium',
    'header.abilityCompendium.label': 'Abilities',
