...
export const en = {
    ...
    'tierblock.witnessAux.description': 'Reserved tier slot for an auxiliary witness-capture pass. No service-side call site today.',
    ...
    'tierblock.npcProfileGen.description': 'Reserved tier slot for LLM-generated NPC profiles. No service-side call site today.',
