...
export const pl: LocalePack = {
    ...
    'header.enemyCompendium.tooltip': 'Kompendium przeciwników',
    'header.enemyCompendium.aria': 'Otwórz kompendium przeciwników',
    'header.enemyCompendium.label': 'Przeciwnicy',
