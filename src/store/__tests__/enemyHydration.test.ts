...
vi.mock('../campaignStore', () => ({
    ...
    getAbilityCompendium: vi.fn().mockResolvedValue([]),
    getCharacterAbilities: vi.fn().mockResolvedValue([]),
    getAbilityRuntimeStates: vi.fn().mockResolvedValue([]),
    getAbilityProposals: vi.fn().mockResolvedValue([]),
