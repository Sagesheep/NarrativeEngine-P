...
export function useChatOperations({
    ...
    const { settings, loreChunks, npcLedger, enemyCompendium, abilityCompendium, characterAbilities, enemyInstances, enemyEncounters, enemyCombatConfig, archiveIndex } = useAppStore(
        useShallow(s => ({
            settings: s.settings,
