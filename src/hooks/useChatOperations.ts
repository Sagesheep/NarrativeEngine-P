...
export function useChatOperations({
    ...
    const { settings, loreChunks, npcLedger, enemyCompendium, abilityCompendium, characterAbilities, abilityRuntimeStates, enemyInstances, enemyEncounters, enemyCombatConfig, archiveIndex } = useAppStore(
        useShallow(s => ({
            settings: s.settings,
            loreChunks: s.loreChunks,
            npcLedger: s.npcLedger,
            enemyCompendium: s.enemyCompendium,
            abilityCompendium: s.abilityCompendium,
            characterAbilities: s.characterAbilities,
            abilityRuntimeStates: s.abilityRuntimeStates,
            enemyInstances: s.enemyInstances,
            enemyEncounters: s.enemyEncounters,
            enemyCombatConfig: s.enemyCombatConfig,
